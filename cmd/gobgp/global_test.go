...
func Test_ParseLsSrPolicyCandidatePath(t *testing.T) {
	...
	assert.NoError(err)
	assert.Equal("NLRI { SRPOLICY_CP { LOCAL_NODE: {ASN: 65001, BGP LS ID: 0, OSPF AREA: 0, IGP ROUTER ID: , BGP ROUTER ID: 1.1.1.1, CONFEDERATION: 0, IPv4: 10.0.0.1, IPv6: invalid IP} ENDPOINT: 10.0.0.2 COLOR: 100 ORIGIN: 3 ORIGINATOR: 65001/1.1.1.1 DISCRIMINATOR: 1 SR:1 } }", nlri.String())
