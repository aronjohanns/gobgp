...
Each `segment-list` argument is one segment list: a weight followed by a comma-separated list of MPLS labels (segment type A) or SRv6 SIDs (segment type B).
...
Each `constraint-metric` is a metric type followed by optional flags from `OMAB` (Optimization metric, Margin, Absolute margin, Bound), margin and bound, for example `1:MAB:5:100`.
...
$ gobgp global rib -a ls
   Network                                                                                                                                                        Next Hop             AS_PATH              Age        Attrs
*> NLRI { SRPOLICY_CP { LOCAL_NODE: {ASN: 65001, BGP LS ID: 0, OSPF AREA: 0, IGP ROUTER ID: , BGP ROUTER ID: 1.1.1.1, CONFEDERATION: 0, IPv4: 10.0.0.1, IPv6: invalid IP} ENDPOINT: 10.0.0.2 COLOR: 100 ORIGIN: 3 ORIGINATOR: 65001/1.1.1.1 DISCRIMINATOR: 1 SR:0 } } 0.0.0.0                                   00:00:03   [{Origin: ?} {LsAttributes: {SR Binding SID: 24001 Specified: 0 Flags: B} {SR CP State: Priority:10 Preference:200 Flags:AEV} {SR CP Name: cp1} {SR Policy Name: blue} {SR Segment List: Weight:1 MTID:0 Algo:0 Flags:EC {Segment: Type:A Label:16002 Algo:0 Flags:SE} {Segment: Type:A Label:24006 Algo:0 Flags:SE}} {SR Segment List: Weight:2 MTID:0 Algo:0 Flags:EC {Segment: Type:A Label:16003 Algo:0 Flags:SE}} }]
```
