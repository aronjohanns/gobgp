...
SR_POLICY_ROUTES = [
    {
        ...
        'nlri': 'IPv4: 10.0.0.1, IPv6: invalid IP} ENDPOINT: 10.0.0.2 COLOR: 100 ORIGIN: 3 ORIGINATOR: 65000/192.168.0.1 DISCRIMINATOR: 1',
        'sr_policy': {
            'policy_name': 'blue',
    ...
    },
    {
        ...
        'nlri': 'IPv4: 10.0.0.1, IPv6: invalid IP} ENDPOINT: 10.0.0.2 COLOR: 100 ORIGIN: 3 ORIGINATOR: 65000/192.168.0.1 DISCRIMINATOR: 2',
        'sr_policy': {
    ...
    },
    {
        ...
        'nlri': 'IPv4: 10.0.0.3, IPv6: invalid IP} ENDPOINT: 10.0.0.2 COLOR: 100 ORIGIN: 3 ORIGINATOR: 65000/192.168.0.1 DISCRIMINATOR: 1',
        'sr_policy': {
...
class GoBGPTestBase(unittest.TestCase):
    ...
    def _wait_for_rib(self, ctn, expected, timeout=30):
        for _ in range(timeout):
            rib = ctn.get_global_rib(rf=RF_LS)
            if len(rib) == expected:
                return rib
            time.sleep(1)
        self.fail('expected {} BGP-LS destinations on {}, got {}'.format(
